...
#$ -N sra_seq_test_02      # name of the job
#$ -o /data/users/$USER/BioinformaticsSG/Getting-Data/sra_seq_test_02.out   # contains what would normally be printed to stdout (the$
#$ -e /data/users/$USER/BioinformaticsSG/Getting-Data/sra_seq_test_02.err   # file name to print standard error messages to. These m$
